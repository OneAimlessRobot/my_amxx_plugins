...
new const zombieclass1_name[] = "Anti-Frost Zombie"
new const zombieclass1_info[] = "- Immune to ice"
...
{
	register_plugin("[ZP] Class: Zombie: Anti-Frost", PLUGIN_VERSION, "Excalibur.007")
