...
#define GRAB_WIDTH		350
#define THROW_WIDTH		10000
#define GRAB_STRENGTH	40
#define TAKE_SPEED		500

#define BATTERY_USAGE	0.2
...
create_weapon()
{
	...
	// Floats
	wpn_set_float(wpnid, wpn_refire_rate1, 0.5)
	wpn_set_float(wpnid, wpn_refire_rate2, 0.5)
	wpn_set_float(wpnid, wpn_reload_time, 3.0)
	wpn_set_float(wpnid, wpn_recoil1, 5.0)
	wpn_set_float(wpnid, wpn_run_speed, 500.0)
	
	// Integers
	wpn_set_integer(wpnid, wpn_ammo1, 200)
	...
	wpn_set_integer(wpnid, wpn_cost, 17000)
