...
public plugin_init()
{
	...
	sh_default_explode_owner_ignore_frac_cvar = register_cvar("sh_default_explode_owner_ignore_frac")
...
public cvarCheck()
{
	...
	sh_default_explode_owner_ignore_frac = get_pcvar_float(sh_default_explode_owner_ignore_frac_cvar)
