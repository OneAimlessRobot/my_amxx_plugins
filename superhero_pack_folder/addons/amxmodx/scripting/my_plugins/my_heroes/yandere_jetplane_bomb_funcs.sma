...
public plugin_init()
{
	...
	pcvar_jetplane_bomb_radius = create_cvar("yandere_jetplane_bomb_radius", "5")
	pcvar_jetplane_bomb_dmg = create_cvar("yandere_jetplane_bomb_dmg", "5")
	pcvar_jetplane_bomb_ammo = create_cvar("yandere_jetplane_bomb_ammo", "5")
