...
public plugin_init()
{
	...
	create_cvar("jeremy_level", "25")
	create_cvar("jeremy_maxrounds_player", "2")
	create_cvar("jeremy_maxrounds_team", "4")
	create_cvar("jeremy_maxrounds_game", "10");
	create_cvar("jeremy_countdown", "10")
	pcvar_gCooldown = create_cvar("jeremy_cooldown", "60.0")
