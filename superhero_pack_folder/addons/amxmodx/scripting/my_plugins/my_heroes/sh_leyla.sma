...
{
	// Plugin Info
	register_plugin("SUPERHERO Leyla", "1.0", AUTHOR)
	
	
	// DO NOT EDIT THIS FILE TO CHANGE CVARS, USE THE SHCONFIG.CFG
	create_cvar("leyla_level", "8")
	create_cvar("leyla_starting_money", "10000")
	create_cvar("leyla_default_give_money", "1000")
	create_cvar("leyla_default_give_radius", "300.0")
