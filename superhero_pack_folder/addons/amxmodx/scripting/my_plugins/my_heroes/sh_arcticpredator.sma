...
{
	engfunc(EngFunc_PrecacheModel,"models/shmod/predgun/predknife.mdl")
	engfunc(EngFunc_PrecacheModel,"models/shmod/predgun/predawp.mdl")
	engfunc(EngFunc_PrecacheModel,"models/shmod/predgun/preddisc.mdl")
	engfunc(EngFunc_PrecacheModel,"models/shmod/predgun/p_predgun.mdl")
	engfunc(EngFunc_PrecacheModel,"models/shmod/predgun/v_predgun.mdl")
	engfunc(EngFunc_PrecacheSound,"weapons/electro5.wav")
	engfunc(EngFunc_PrecacheSound, "items/tr_kevlar.wav")
	engfunc(EngFunc_PrecacheSound, "ambience/disgusting.wav" )
