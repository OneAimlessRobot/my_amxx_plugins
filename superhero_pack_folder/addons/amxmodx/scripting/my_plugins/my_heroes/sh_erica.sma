...
public plugin_init()
{
	...
	pcvar_speed_points_er_radius_pct = register_cvar("erica_speed_points_radius_pct", "0.1")
	pcvar_base_er_radius = register_cvar("erica_base_radius", "500")
	...
	pcvar_num_mollies = register_cvar("erica_num_mollies", "0")
	pcvar_speed_speed_er_points_pct = register_cvar("erica_speed_speed_points_pct", "0.1")
...
public erica_damage(id)
{
	...
	if (floatround(extraDamage)>0){
		...
		sh_extra_damage(id,attacker,floatround(extraDamage),
						dmg_source_name_short_hype_shot,bodypart,_,_,_,_,_,
