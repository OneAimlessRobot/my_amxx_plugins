...
public plugin_init()
{
	...
	pcvar_ester_fly_health_spend = register_cvar("ester_fly_health_spend", "25.0")
...
{	
	...
	{ 
		...
		if(generate_int(0, FlameAndSoundRate) <3)
		{
			...
			velocity_by_aim(id, floatround(cvar_val(float,pcvar_ester_flyspeed)), Velocity)
