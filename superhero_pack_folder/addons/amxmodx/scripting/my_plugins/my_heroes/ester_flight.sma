...
public plugin_init()
{
	...
	pcvar_ester_fly_desperate_health_frac = register_cvar("ester_fly_desperate_health_frac", "0.3")
	pcvar_ester_fly_despondent_health_frac = register_cvar("ester_fly_despondent_health_frac", "0.9")
