...
{
	// Plugin Info
	register_plugin("SUPERHERO Grim Reaper Pt2", "1.0", AUTHOR)
	
	// DO NOT EDIT THIS FILE TO CHANGE CVARS, USE THE SHCONFIG.CFG
	create_cvar("greaper2_level", "8")
	create_cvar("greaper2_inf_swings", "0")
	create_cvar("greaper2_range", "1000.0")
	create_cvar("greaper2_num_swings", "8")
