...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("Marksman_level", "8")
	create_cvar("Marksman_g3sg1mult", "2.0")
	create_cvar("Marksman_sg550mult", "2.0")
	create_cvar("Marksman_alphainc", "10" )
	
	create_cvar("Marksman_maxalpha", "50" )
	
	create_cvar("Marksman_minalpha", "5" )
