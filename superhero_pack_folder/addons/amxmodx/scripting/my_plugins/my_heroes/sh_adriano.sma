...
public plugin_init()
{
	...
	create_cvar("adriano_level", "8")
	create_cvar("adriano_speed_points_radius_pct", "0.1")
	create_cvar("adriano_base_radius", "500")
	create_cvar("adriano_max_radius", "1000")
	create_cvar("adriano_base_points", "1000")
	create_cvar("adriano_max_points", "1000")
	create_cvar("adriano_base_speed", "500")
	create_cvar("adriano_max_speed", "1000")
	create_cvar("adriano_speed_speed_points_pct", "0.1")
	create_cvar("adriano_dmg_speed_points_pct", "0.1")
	create_cvar("adriano_speed_points_heal", "100")
	create_cvar("adriano_speed_points_heal_coeff", "4")
