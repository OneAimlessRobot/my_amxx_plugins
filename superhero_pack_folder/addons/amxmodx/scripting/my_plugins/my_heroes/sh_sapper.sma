...
public plugin_init()
{
	...
	pcvar_num_mines = register_cvar("sapper_mines", "8")
	pcvar_mine_cooldown = register_cvar("sapper_disarmable", "1")
	pcvar_disarmable = register_cvar("sapper_mine_cooldown", "10")
