...
public plugin_init()
{
	...
	//recoil_ratio
	pcvar_base_recoil_ratio = create_cvar("komak_base_recoil_ratio", "0.2")
	...
	pcvar_max_recoil_ratio = create_cvar("komak_max_recoil_ratio", "0.2")
	pcvar_max_reload_ratio = create_cvar("komak_max_reload_ratio", "0.2")
	pcvar_max_fire_ratio = create_cvar("komak_max_fire_ratio", "0.2")
	
	pcvar_recoil_ratio_per_hit = create_cvar("komak_recoil_ratio_per_hit", "0.2")
