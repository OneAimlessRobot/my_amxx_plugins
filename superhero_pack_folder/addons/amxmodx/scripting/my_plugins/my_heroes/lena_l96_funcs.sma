...
public plugin_init(){
	...
	RegisterHam(Ham_Item_Deploy, weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_ItemDeployPre",_,true)
	RegisterHam(Ham_Weapon_PrimaryAttack, weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_WeaponPrimaryAttackPre",_,true)
	RegisterHam(Ham_Weapon_PrimaryAttack, weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_Weapon_PrimaryAttack_Post", 1,true)	
	register_forward(FM_UpdateClientData, "fm_UpdateClientDataPost", 1)
	RegisterHam(Ham_Item_PostFrame, weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_Item_PostFrame",_,true)	
	
	
	RegisterHam(Ham_TraceAttack, "player", "Ham_TraceAttackLenaL96",_,true)
	
	RegisterHam(Ham_Weapon_Reload,weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_WeaponReloadPre",_,true)
	RegisterHam(Ham_Weapon_Reload, weapon_data_strings_array[LENA_WEAPON_CLASSID][wpn_struct_weapon_name], "fw_Weapon_Reload_Post", 1,true)
