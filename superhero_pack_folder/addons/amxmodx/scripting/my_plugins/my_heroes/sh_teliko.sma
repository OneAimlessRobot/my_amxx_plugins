...
public plugin_init()
{
	...
	pcvar_gHeroLevel = register_cvar("Teliko_level", "8")
	pcvar_max_counter_bullets = register_cvar("Teliko_max_bullets", "10")
	pcvar_max_inc_lvl_inc = register_cvar("Teliko_max_plus_lvl_inc", "5")
	pcvar_COUNTER_DMG_Mult = register_cvar("Teliko_counter_dmg_mult", "2.0")
	pcvar_famas_level_diff = register_cvar("Teliko_famas_level_diff", "3")
	pcvar_base_counter_bullets = register_cvar("Teliko_base_bullets", "10")
	pcvar_COUNTER_BULLET_PCT = register_cvar("Teliko_get_bullet_pct", "0.5")
	pcvar_max_bullets_p_inc = register_cvar("Teliko_max_bullets_per_inc", "5")
	pcvar_start_counter_bullets = register_cvar("Teliko_start_counter_bullets", "30")
	pcvar_MEGA_COUNTER_STUN_TIME = register_cvar("Teliko_mega_counter_stun_time", "3.0")
	pcvar_MEGA_COUNTER_EFFECTS_THRESHOLD = register_cvar("Teliko_mega_counter_effects_threshold", "3")
	pcvar_num_chaffs = register_cvar("Teliko_num_chaffs", "8")
