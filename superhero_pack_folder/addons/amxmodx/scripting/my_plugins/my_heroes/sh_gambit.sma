...
public plugin_init()
{
	...
	create_cvar("gambit_level", "0")
	pcvar_dmg_mult = create_cvar("gambit_grenademult", "60.9")
	create_cvar("gambit_grenadetimer", "30.0")
	create_cvar("gambit_chance", "6.0") // 6.0 means 1 in 6 chance. 6.1 means 1 in 6.1
	create_cvar("gambit_powertimer", "6.0") //timer for powernades
