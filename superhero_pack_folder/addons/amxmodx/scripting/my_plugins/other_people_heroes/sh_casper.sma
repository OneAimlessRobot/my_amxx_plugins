...
public plugin_init()
{
	...
	create_cvar("casper_level", "8")
	create_cvar("casper_health", "50")
	create_cvar("casper_armor", "25")
	create_cvar("casper_stuckcheck", "1")
...
public casper_setghost(id)
{
	...
	set_user_rendering(id, kRenderFxGlowShell, 1, 1, 1, kRenderTransAlpha, 1)
