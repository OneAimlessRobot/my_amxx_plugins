...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("xavier_level", "7")
	gPcvarTrailLength = create_cvar("xavier_traillength", "25")
	gPcvarShowTeam = create_cvar("xavier_showteam", "0")
	gPcvarShowEnemy = create_cvar("xavier_showenemy", "1")
	gPcvarRefreshTimer = create_cvar("xavier_refreshtimer", "5.0")
