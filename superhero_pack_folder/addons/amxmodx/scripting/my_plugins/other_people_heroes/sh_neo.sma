...
public plugin_init()
{
	...
	create_cvar("neo_level", "10")
	create_cvar("neo_health", "150")
	create_cvar("neo_armor", "350")
	create_cvar("neo_gravity", "5.0")
	create_cvar("neo_speed", "900")
	create_cvar("neo_mode", "1" )
	create_cvar("neo_flyspeed","1000") 
	create_cvar("neo_flybeforeftime","1") 
	create_cvar("neo_fly_upforce","1000") 
	create_cvar("neo_fly_downforce","1000") 
	create_cvar("neo_toggle","0")
