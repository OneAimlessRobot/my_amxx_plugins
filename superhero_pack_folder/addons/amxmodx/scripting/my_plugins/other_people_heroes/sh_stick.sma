...
public plugin_init()
{
	...
	create_cvar("stick_level", "0")
	create_cvar("stick_speed", "560")
	create_cvar("stick_radius", "1024")
	create_cvar("stick_bright", "192")
	create_cvar("stick_teamcolored", "0")
	create_cvar("stick_enemyonly", "0")
