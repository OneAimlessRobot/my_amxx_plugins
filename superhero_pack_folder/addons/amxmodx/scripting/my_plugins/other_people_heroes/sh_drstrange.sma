...
public plugin_init()
{
	...
	create_cvar("drstrange_level", "9")
	create_cvar("drstrange_armor", "200")
	create_cvar("drstrange_gravity", "0.40")
	create_cvar("drstrange_pctperlev", "0.02")
	create_cvar("drstrange_godsecs", "1")
	create_cvar("drstrange_respawnpct", "50")
	create_cvar("drstrange_respawncooldown", "0.0")
	create_cvar("drstrange_bolt_ammo", "30")
	create_cvar("drstrange_bolt_burndecals", "1")
	create_cvar("drstrange_multishot", "0.20")
	create_cvar("drstrange_cooldown", "0.0")
