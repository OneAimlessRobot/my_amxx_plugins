...
public plugin_init()
{
	...
	create_cvar("ghostface_level", "0")
	create_cvar("ghostface_health", "100")
	create_cvar("ghostface_armor", "100")
	create_cvar("ghostface_gravity", "1.0")
	create_cvar("ghostface_knifespeed", "290")
	CvarKnifeDmgMult = create_cvar("ghostface_knifemult", "1.5")
	CvarHealPoints = create_cvar("ghostface_healpoints", "5")
