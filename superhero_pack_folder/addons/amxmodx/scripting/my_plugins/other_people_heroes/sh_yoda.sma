...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("yoda_level", "9")
	gPcvarCooldown = create_cvar("yoda_cooldown", "10")
	pradius = create_cvar("yoda_radius", "400")
	ppower = create_cvar("yoda_power", "600")
	pdmg = create_cvar("yoda_damage", "10")
	pselfdmg = create_cvar("yoda_selfdmg", "0")
...
public force_push(id)
{
	...
	new players[SH_MAXSLOTS], playerCount, victim
