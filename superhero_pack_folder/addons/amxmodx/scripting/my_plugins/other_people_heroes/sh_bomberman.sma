...
public plugin_init()
{
	...
	gPcvarLevel = create_cvar("bomberman_level", "0")
	gPcvarCooldown = create_cvar("bomberman_cooldown", "5")
	gPcvarBombs = create_cvar("bomberman_bombs", "1")
	gPcvarBPL = create_cvar("bomberman_bpl", "0")
	gPcvarRadius = create_cvar("bomberman_radius", "400")
	gPcvarMaxDamage = create_cvar("bomberman_maxdamage", "100")
