...
public plugin_init()
{
	...
	create_cvar("lancer_level", "3")
	create_cvar("lancer_damage", "30")
	create_cvar("lancer_radius", "290")
	create_cvar("lancer_cooldown", "0")
	create_cvar("lancer_torpedospeed", "600")
	create_cvar("lancer_blast_decals", "1")
