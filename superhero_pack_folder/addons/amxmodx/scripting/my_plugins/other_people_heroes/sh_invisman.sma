...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("invisman_level", "0")
	gPcvarAlpha = create_cvar("invisman_alpha", "50")
	gPcvarDelay = create_cvar("invisman_delay", "5.0")
	gPcvarCheckMove = create_cvar("invisman_checkmove", "1.0")
	gPcvarCheckOnGround = create_cvar("invisman_checkonground", "0")
