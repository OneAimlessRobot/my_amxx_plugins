...
public plugin_init()
{
	...
	create_cvar("scorpion_level", "9")
	create_cvar("scorpion_maxhooks", "30")
	create_cvar("scorpion_reelspeed", "1000")
	create_cvar("scorpion_dragmates", "0")
	create_cvar("scorpion_knifefight", "0")
	create_cvar("scorpion_mode", "1")
	create_cvar("scorpion_uppercutdmg", "20")
	create_cvar("scorpion_speardmg", "20")
	create_cvar("scorpion_stuntime", "2")
