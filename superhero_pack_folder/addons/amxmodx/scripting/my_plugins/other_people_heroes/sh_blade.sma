...
public plugin_init()
{
	...
	switch(functionReturn)
	{
		...
		default:
		{
			...
			create_cvar("blade_level", "5")
			create_cvar("blade_speed", "350")
			CvarKnifeBurns = create_cvar("blade_knifeburns", "8")
			CvarKnifeDmg = create_cvar("blade_knifeburndmg", "5")
			CvarGunBurns = create_cvar("blade_gunburns", "5")
			CvarGunDmg = create_cvar("blade_gunburndmg", "3")
