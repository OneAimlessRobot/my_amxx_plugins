...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("magneto_level", "10")
	pCvarCooldown = create_cvar("magneto_cooldown", "45")
	pCvarBoost = create_cvar("magneto_boost", "125")
	pCvarGiveGlock = create_cvar("magneto_giveglock", "1")
