...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("hulk_level", "0")
	gPcvarRadius = create_cvar("hulk_radius", "1800")
	gPcvarCooldown = create_cvar("hulk_cooldown", "7")
	gPcvarStunTime = create_cvar("hulk_stuntime", "3")
	gPcvarStunSpeed = create_cvar("hulk_stunspeed", "70")
