...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("htorch_level", "0")
	pCvarArmorCost = create_cvar("htorch_armorcost", "15")
	pCvarNumBurns = create_cvar("htorch_numburns", "5")
	pCvarBurnDamage = create_cvar("htorch_burndamage", "10")
...
public on_fire(args[])
{
	...
	sh_extra_damage(id, attacker, get_pcvar_num(pCvarBurnDamage), _, SH_DMG_NORM, _, forigin)
}
//----------------------------------------------------------------------------------------------
