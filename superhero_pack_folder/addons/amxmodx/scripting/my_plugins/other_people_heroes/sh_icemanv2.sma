...
public plugin_init()
{
	...
	create_cvar("iceman2_level", "0" )
	create_cvar("iceman2_timer", "0.1" )
	create_cvar("iceman2_maxspeed", "450" )
	create_cvar("iceman2_armorfuel", "1" )
	create_cvar("iceman2_fuelcost","2")
	create_cvar("iceman2_armor","100")
