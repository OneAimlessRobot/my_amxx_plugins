...
public plugin_init()
{
	...
	create_cvar("cyclone_level", "9" )
	create_cvar("cyclone_cooldown", "60" )
	create_cvar("cyclone_range", "1000" )
	create_cvar("cyclone_force", "800" )
	create_cvar("cyclone_time", "100" )
	create_cvar("cyclone_playersonly", "1" )
