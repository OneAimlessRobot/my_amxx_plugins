...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("wildcard_level", "15")
	pCvarAK47Mult = create_cvar("wildcard_ak47mult", "1.0")
	gPcvarMaxDamage = create_cvar("wildcard_damage", "20")
	gPcvarSpeed = create_cvar("wildcard_speed", "2000.0")
