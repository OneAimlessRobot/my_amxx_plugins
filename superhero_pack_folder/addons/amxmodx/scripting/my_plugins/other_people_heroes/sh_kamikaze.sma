...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("kamikaze_level", "0")
	pCvarRadius = create_cvar("kamikaze_radius", "300")
	pCvarFuse = create_cvar("kamikaze_fuse", "15")
	pCvarMaxDamage = create_cvar("kamikaze_maxdamage", "125")
