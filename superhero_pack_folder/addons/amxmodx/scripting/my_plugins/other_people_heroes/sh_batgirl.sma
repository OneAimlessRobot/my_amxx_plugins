...
public plugin_init()
{
	...
	create_cvar("batgirl_level", "9")
	gPcvarMoveAcc = create_cvar("batgirl_moveacc", "650")
	gPcvarReelSpeed = create_cvar("batgirl_reelspeed", "1000")
	gPcvarHookStyle = create_cvar("batgirl_hookstyle", "3")
	gPcvarHookSky = create_cvar("batgirl_hooksky", "0")
	gPcvarTeamColored = create_cvar("batgirl_teamcolored", "1")
	gPcvarMaxHooks = create_cvar("batgirl_maxhooks", "-1")
