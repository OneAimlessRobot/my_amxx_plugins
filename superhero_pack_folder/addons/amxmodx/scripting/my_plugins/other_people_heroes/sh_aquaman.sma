...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("aquaman_level", "0")
	gPcvarArmorCost = create_cvar("aquaman_armorcost", "0")
	gPcvarNumBubbles = create_cvar("aquaman_numbubbles", "7")
	gPcvarBubbleDamage = create_cvar("aquaman_bubbledamage", "10")
