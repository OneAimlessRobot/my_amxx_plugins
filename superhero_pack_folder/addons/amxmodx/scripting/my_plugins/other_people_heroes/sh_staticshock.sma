...
public plugin_init()
{
	...
	create_cvar("shock_level", "0" )
	create_cvar("shock_timer", "0.1" )
	create_cvar("shock_maxspeed", "930" )
	create_cvar("shock_armorfuel", "1" )
	create_cvar("shock_fuelcost","2")
	create_cvar("shock_armor","250")
