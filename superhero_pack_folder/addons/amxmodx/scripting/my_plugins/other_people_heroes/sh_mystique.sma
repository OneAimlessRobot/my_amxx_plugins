...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("mystique_level", "0")
	pCvarCooldown = create_cvar("mystique_cooldown", "0")
	pCvarMaxTime = create_cvar("mystique_maxtime", "0")
	pCvarToggle = create_cvar("mystique_toggle", "1")
