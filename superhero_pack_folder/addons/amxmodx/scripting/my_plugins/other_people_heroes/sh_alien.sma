...
public plugin_init()
{
	...
	create_cvar("alien_level", "5")
	create_cvar("alien_health", "125")
	create_cvar("alien_armor", "125")
	CvarKnifeMult = create_cvar("alien_knifemult", "0.0")
	CvarZoomVision = create_cvar("alien_vision", "160")
	CvarTint = create_cvar("alien_tint", "50")
	CvarAlphaValue = create_cvar("alien_alpha", "50")
	CvarMode = create_cvar("alien_knifemode", "0")
