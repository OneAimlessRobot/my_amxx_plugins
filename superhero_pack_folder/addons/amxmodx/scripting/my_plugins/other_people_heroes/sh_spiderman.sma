...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("spiderman_level", "0")
	pCvarMoveAcc = create_cvar("spiderman_moveacc", "140")
	pCvarReelSpeed = create_cvar("spiderman_reelspeed", "400")
	pCvarHookStyle = create_cvar("spiderman_hookstyle", "2")
	pCvarMaxHooks = create_cvar("spiderman_maxhooks", "60")
	pCvarTeamColored = create_cvar("spiderman_teamcolored", "1")
