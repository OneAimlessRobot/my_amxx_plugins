...
public plugin_init()
{
	...
	create_cvar("SuperAlien_level", "5")
	create_cvar("SuperAlien_health", "125")
	create_cvar("SuperAlien_armor", "125")
	CvarKnifeMult = create_cvar("SuperAlien_knifemult", "0.0")
	CvarZoomVision = create_cvar("SuperAlien_vision", "160")
	CvarTint = create_cvar("SuperAlien_tint", "50")
	CvarAlphaValue = create_cvar("SuperAlien_alpha", "50")
	CvarMode = create_cvar("SuperAlien_knifemode", "0")
