...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("zeus_level", "0")
	gPcvarChance = create_cvar("zeus_chance", "0.05")
	gPcvarWorkInside = create_cvar("zeus_workinside", "0")
	gPcvarBurnDecals = create_cvar("zeus_burndecals", "1")
