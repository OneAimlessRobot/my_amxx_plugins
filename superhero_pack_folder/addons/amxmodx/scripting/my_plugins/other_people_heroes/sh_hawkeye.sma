...
public plugin_init()
{
	...
	create_cvar("hawk_level", "9")
	create_cvar("hawk_health", "75")
	create_cvar("hawk_armor", "100")
	create_cvar("hawk_speed", "500")
	create_cvar("hawk_showdmg", "1")
	create_cvar("hawk_freewpn", "1")
