...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("electro_level", "0")
	gPcvarCooldown = create_cvar("electro_cooldown", "45")
	gPcvarSearchTime = create_cvar("electro_searchtime", "45")
	gPcvarMaxDamage = create_cvar("electro_maxdamage", "50")
	gPcvarJumpDecay = create_cvar("electro_jumpdecay", "0.66")
	gPcvarJumpRadius = create_cvar("electro_jumpradius", "500")
...
public electro_jump_check(parm[4])
{
	...
	new players[SH_MAXSLOTS], numberofplayers, i
...
electro_attack(const victim, const attacker, const damage, const linewidth, const beamStartID)
{
	...
	// Damage the user
	sh_extra_damage(victim, attacker, damage, MY_HIT_GENERIC, SH_DMG_NORM, SH_EXTRA_DMG_FLAG_STUN, beamOrigin)
