...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("skeletor_level", "0")
	pCvarCooldown = create_cvar("skeletor_cooldown", "30")
	pCvarCampTime = create_cvar("skeletor_camptime", "10")
	pCvarMoveDist = create_cvar("skeletor_movedist", "10")
	pCvarMaxSnarks = create_cvar("skeletor_maxsnarks", "10")
