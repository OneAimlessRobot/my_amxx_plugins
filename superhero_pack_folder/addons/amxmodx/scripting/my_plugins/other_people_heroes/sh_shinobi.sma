...
public plugin_init()
{
	...
	cvar_level		= create_cvar("shinobi_level",	"9")
	cvar_smoke_delay	= create_cvar("shinobi_cooldown", 	"18.0")
	cvar_wall_power		= create_cvar("shinobi_walljump", 	"900")
	cvar_jump_power		= create_cvar("shinobi_longjump", 	"550")
	cvar_max_stealth	= create_cvar("shinobi_stealth", 	"18.8")
	cvar_shur_speed		= create_cvar("shinobi_shur_speed", 	"1200")
	cvar_shur_damage	= create_cvar("shinobi_shur_dmg", 	"7")
	cvar_shur_num		= create_cvar("shinobi_shur_pack", 	"17")
	cvar_shur_delay		= create_cvar("shinobi_shur_delay", 	"10.0")
