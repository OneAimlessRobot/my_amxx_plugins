...
public plugin_init()
{
	...
	create_cvar("bass_level", "10")
	create_cvar("bass_health", "200")
	create_cvar("bass_armor", "200")
	create_cvar("bass_speed", "200")
	create_cvar("bass_gravity", "0.40")
	create_cvar("bass_laser_ammo", "1000")
	create_cvar("bass_laser_burndecals", "1")
	create_cvar("bass_cooldown", "0.0")
	create_cvar("bass_multishot", "0.1")
