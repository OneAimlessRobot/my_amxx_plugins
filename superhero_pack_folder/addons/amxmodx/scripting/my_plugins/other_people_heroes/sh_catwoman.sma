...
public plugin_init()
{
	...
	create_cvar("catwoman_level", "1")
	create_cvar("catwoman_seconds", "0.5")
	create_cvar("catwoman_change", "10.0")
	create_cvar("catwoman_mode", "2")
	create_cvar("catwoman_pctperlev", "0.01")
	create_cvar("catwoman_maxrounds", "20")
	create_cvar("catwoman_minrounds", "5")
