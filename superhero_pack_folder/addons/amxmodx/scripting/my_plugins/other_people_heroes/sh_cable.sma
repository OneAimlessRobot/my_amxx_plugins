...
public plugin_init()
{
	...
	create_cvar("cable_level", "12" )
	create_cvar("cable_laser_ammo", "500")  // total # of shots...
	create_cvar("cable_laser_burndecals", "1")
	create_cvar("cable_cooldown", "0.02" )
	create_cvar("cable_mulishot", "0.02" ) //Delay for multishots on holding key down
