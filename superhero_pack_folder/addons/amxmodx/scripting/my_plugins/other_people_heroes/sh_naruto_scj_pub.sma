...
public plugin_init()
{
	...
	new pcvarLevel 		= 	create_cvar("naruto_level", "4")
	pCvardamage 		= 	create_cvar("naruto_damage", "1")
	pCvarrdamage		= 	create_cvar("naruto_rdamage", "100")
	pCvarCooldown 		= 	create_cvar("naruto_cooldown", "20")
	pCvarGunCooldown 	= 	create_cvar("naruto_delayshot", "0.1")
	pCvarMaxChakra 		= 	create_cvar("naruto_maxchakra", "15")
	pCvarRasenganCost 	= 	create_cvar("naruto_rasengancost", "7")
	pCvarSFXRadius 		= 	create_cvar("naruto_sfxradius", "100")
	pCvarHitChance 		= 	create_cvar("naruto_hitchance", "65")
...
{
	sh_extra_damage(id, attacker_id, get_pcvar_num(pCvardamage))
}
public rasengan_damage(id,attacker_id)
{
	sh_extra_damage(id, attacker_id, get_pcvar_num(pCvarrdamage))
}
