...
public plugin_init()
{
	...
	new pcvarLevel 		= create_cvar("danimoth_level", 		"10")
	pCvarCooldown 		= create_cvar("danimoth_cooldown", 		"45" )
	pCvarFreezeRadius 	= create_cvar("danimoth_freezeradius", 	"750" ) 
	pCvarFreezeTime 	= create_cvar("danimoth_freezetime", 		"10.0" )
	pCvarPrismLife		= create_cvar("danimoth_prismlife", 		"100" )
	pCvarCloakRadius 	= create_cvar("danimoth_radius", 		"750" )
	pCvarCloakPercent 	= create_cvar("danimoth_alpha", 		"20")
