...
public plugin_init()
{
	...
	create_cvar("triedge_level", "13")
	create_cvar("triedge_maxhooks", "-1")
	create_cvar("triedge_reelspeed", "1750")
	create_cvar("triedge_dragmates", "0")
	create_cvar("triedge_mode", "3")
	create_cvar("triedge_strikedmg", "10")
	create_cvar("triedge_finaldmg", "25")
	create_cvar("triedge_infinitydmg", "25")
	create_cvar("triedge_maxheal", "100")
	create_cvar("triedge_markdmg", "5")
	create_cvar("triedge_stuntime", "2")
	create_cvar("triedge_godsecs", "4")
    ...
    if ( is_user_alive(hooktarget) ) {
        ...
        if ( get_user_team(hooktarget) != get_user_team(id) ) {
            ...
            if ( mode >= 2 ) {
                ...
                sh_extra_damage(hooktarget, id, get_cvar_num("triedge_markdmg"))
...
public strike(parm[])
{
    ...
    sh_extra_damage(vic, id, get_cvar_num("triedge_strikedmg"))
}
//----------------------------------------------------------------------------------------------
...
public Finisher(parm[])
{
    ...
    sh_extra_damage(vic, id, get_cvar_num("triedge_finaldmg"))
}
//----------------------------------------------------------------------------------------------
public Infinity_Finisher(parm[])
{
    ...
    sh_extra_damage(vic, id, get_cvar_num("triedge_infinitydmg"))
