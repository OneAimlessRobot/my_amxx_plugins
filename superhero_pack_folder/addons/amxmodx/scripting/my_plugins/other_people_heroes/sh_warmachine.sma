...
public plugin_init()
{
	...
	create_cvar("warmachine_level", "0")
	create_cvar("warmachine_dmgmult", "1.5")
	create_cvar("warmachine_timer", "0.1")
	create_cvar("warmachine_thrust", "110")
	create_cvar("warmachine_maxspeed", "400")
	create_cvar("warmachine_xymult", "1.15")
	create_cvar("warmachine_armorfuel", "1")
	create_cvar("warmachine_fuelcost", "2")
	create_cvar("warmachine_armor", "150")
