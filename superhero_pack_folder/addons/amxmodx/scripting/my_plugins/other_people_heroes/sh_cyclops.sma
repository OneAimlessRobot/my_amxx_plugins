...
public plugin_init()
{
	...
	new pcvarLevel = create_cvar("cyclops_level", "5")
	gPcvarLaserAmmo = create_cvar("cyclops_laser_ammo", "20")
	gPcvarBurnDecals = create_cvar("cyclops_laser_burndecals", "1")
	gPcvarCooldown = create_cvar("cyclops_cooldown", "0.20")
	gPcvarMultiShot = create_cvar("cyclops_multishot", "0.2")
