...
public plugin_init()
{
	...
	create_cvar("black_level", "3")
	create_cvar("black_time", "15")
	create_cvar("black_cooldown", "30")
	create_cvar("black_range", "1000")
	create_cvar("black_force", "800")
	create_cvar("black_adminflag", "o")
	create_cvar("black_thinktime", "2")
