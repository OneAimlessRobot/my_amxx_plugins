...
public plugin_init()
{
	...
	create_cvar("chucky_level", "10")
	create_cvar("chucky_knifespeed", "720")
	CvarKnifeMult = create_cvar("chucky_knifemult", "2.5")
	CvarCooldown = create_cvar("chucky_cooldown", "600")
