...
public plugin_precache() {
        precache_model("models/player/admin_mdls/takina_ct/takina_ct.mdl")
        precache_model("models/player/admin_mdls/takina_te/takina_te.mdl")
...
public resetModel(id, level, cid) {
        if (get_user_flags(id) & ADMIN_KICK) {
                ...
                if (userTeam == CS_TEAM_T) {
                        cs_set_user_model(id, "takina_te")
                }
                else if(userTeam == CS_TEAM_CT) {
                        cs_set_user_model(id, "takina_ct")
                }
                else {
