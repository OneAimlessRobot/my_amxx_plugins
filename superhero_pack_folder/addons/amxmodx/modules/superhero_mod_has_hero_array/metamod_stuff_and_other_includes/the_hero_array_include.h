...
public:
	...
	int32_t get_max_hero_props(void);
	...
	int32_t get_max_client_states(void);
...
*/
inline int32_t HeroArrays::get_max_hero_props(void){
...
inline int32_t HeroArrays::get_max_client_states(void){
