...
while [ true ]; do
	...
	taskset -c 0 bash ./server.sh -dew -appid 10 -pingboost 2 -noipx -nojoy -console -num_edicts 3072 -zone 8192 -heapsize 131072 -game cstrike +ip "localhost" +hostport "27015" +port "27015" +maxplayers "10"
