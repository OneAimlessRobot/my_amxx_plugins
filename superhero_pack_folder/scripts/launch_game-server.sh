...
while [ true ]; do
	...
	sleep 2
	taskset -c 0 bash ./server.sh -dew -appid 10 -pingboost 2 -noipx -nojoy -console -num_edicts 3072 -zone 8192 -heapsize 131072 -game cstrike +ip "192.168.0.100" +hostport "27015" +maxplayers "16"
