...
while [ true ]; do
	bash ./server.sh -dew -appid 10 -pingboost 2 -noipx -nojoy -console -num_edicts 3072 -zone 8192 -heapsize 131072 -game cstrike +ip "127.0.0.1" +hostport "27015" +maxplayers "16"
