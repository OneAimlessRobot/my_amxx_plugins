...
new const zclass_name[] = { "VIP Smoker" }
new const zclass_info[] = { "Grab Players [R]" }
...
public zp_fw_core_infect_post(id)
{
	...
	else
	{
		MarkUserAllow(id)
		g_lastHook[id] = 0.0
		ColorChat(id, GREEN, "^1[^4Smoker^1] Press^4 R^1 to use your skills.")
	}
}
...
public drag_start(id) 
{
	...
	else
	{
		...
		if (IsUserAlive(hooktarget)) 
		{
			...
			{
				ColorChat(id, GREEN, "^1[^4ZP^1] You can't grab your teammates.")
				return
			}
