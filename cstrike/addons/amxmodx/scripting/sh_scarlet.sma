...
public plugin_init() 
{
	...
	sh_hero_info(g_heroID, "Walk up walls", "Press the bound key and run into a wall to climb up it!")
	sh_hero_bind(g_heroID, true)
	sh_hero_level(g_heroID, get_cvar_num("scarlet_level"))
}
//----------------------------------------------------------------------------------------------
