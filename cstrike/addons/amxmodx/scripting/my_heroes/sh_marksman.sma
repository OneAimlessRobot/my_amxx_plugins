...
new const g_psg1Model[2][]={"models/shmod/marksman/psg1/v_sg550.mdl","models/shmod/marksman/psg1/p_sg550.mdl"}
...
public plugin_precache()
{
	...
	strcat(g_models[1],g_psg1Model[1],127)
	strcat(g_models[2],g_dragunovModel[0],127)
	strcat(g_models[3],g_dragunovModel[1],127)
...
switch_model(id)
{
	...
	if ( wpnid == CSW_SG550 ) {
		...
		entity_set_string(id, EV_SZ_weaponmodel, g_psg1Model[1])
	}
