   ...
   /* - - - - - - - - - - -
    ...
    /* - - -
     |  Customization  |
        ...
        #define CROSSBOW_RUN_SPEED         295.0   // Max speed ( float )
        #define CROSSBOW_AMMO1             50      // Clip size
        #define CROSSBOW_AMMO2             51      // Ammo size
        #define CROSSBOW_COST              33000   // Cost
    ...
    /* - - -
     |  Weapon information   |
                       - - - */
        new
            gs_WpnName [] = "Red Battle-Crossbow",
            gs_WpnShort[] = "rbow";
    ...
    public plugin_precache()
    {
        ...
        gi_WExplosion = precache_model ( "sprites/xfire2.spr" );
        gi_Fireball   = precache_model ( "sprites/richo2.spr" );
    ...
    CreateWeapon ()
    {
        ...
        wpn_set_float ( i_Weapon_id, wpn_refire_rate1, 0.50 );
