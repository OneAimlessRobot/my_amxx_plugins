...
{
	"models/v_dbarell.mdl", // V
	"models/p_dbarell.mdl", // P
	"models/w_dbarell.mdl" // W
}
...
public plugin_init() 
{
	...
	register_clcmd("say /gatling", "get_gatling")
}
...
public Event_Gatling_Shoot(id)
{
	...
	emit_sound(id, CHAN_WEAPON, WeaponSound[0], 1.0, 0.4, 0, 94 + random_num(0, 15))
}
