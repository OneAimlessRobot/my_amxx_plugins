		...
		if((i==id)||!is_user_connected(i)){
			...
			if((user_team==other_user_team)){
				...
				if(distance<gNormalHealRadius[id]){
					...
					setScreenFlash(i,250,250,210,3,100)
					setScreenFlash(id,250,250,210,3,100)
					sh_set_rendering(i, 250,250,210,255,kRenderFxGlowShell, kRenderTransAlpha)	
					sh_set_rendering(id, 250,250,210,255,kRenderFxGlowShell, kRenderTransAlpha)
