   ...
   /* - - - - - - - - - - -
    ...
    /* - - -
     |  Customization  |
        ...
        #define HIVEHAND_SPEED       290.0    // Player's speed when holding the weapon.
        #define HIVEHAND_AMMO        40       // Max hornets.
        #define HIVEHAND_COST        100000   // Cost of the weapon.
        #define HIVEGUN_REGEN_SPEED  0.1      // Regenerate speed. ( 1 hornet by x second ) ( float ).
        
        #define HORNET_RED_SPEED     300.0    // Red hornet speed ( float ).
        #define HORNET_ORANGE_SPEED  1000.0   // Orage hornet speed ( float ).
        #define HORNET_BUZZ_VOLUME   0.9      // Buzz volume ( float ).
        ...
        #define HORNET_DAMAGE        25       // Damage by hornet.
    
    /* - - -
     |  Weapon information   |
                       - - - */
        new
            gs_WpnName [] = "Hivehand (Alien Life Form)",
